...
const inicio = generarItem('Inicio', faHouseUser, CLIENTE.PROFESIONALES_URL);
...
const revisiones = generarItem(
  'Revisiones',
  faUserEdit,
  CLIENTE.REVISIONES_URL
);
...
const devoluciones = generarItem(
  'Devoluciones',
  faUserEdit,
  CLIENTE.DEVOLUCIONES_URL
);

export const sidebarItemsAuthor = [inicio, perfil, grupos, revisiones, salir];
export const sidebarItemsProfessional = [
  inicio,
  perfil,
  grupos,
  trabajos,
